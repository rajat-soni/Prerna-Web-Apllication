    ...
    <head>
        ...
        <body id ="demoBody">
            <div class="container " id="contnr">
                                    ...
                                    <!-- <form> -->
                                        ...
                                        <div class="col-lg-12 loginbttm">
                                            ...
                                            <div class="col-lg-6 login-btm login-button">
                                               <button type="button" class="btn btn-outline-primary" onclick ="loginFun()">LOG IN</button>
                                            </div>
                                        </div>
                                    <!-- </form> -->
                                </div>
                ...
                <script type="text/javascript" src ="../Assets/Customjs/loginPage.js"></script>
        </body>
</html>
